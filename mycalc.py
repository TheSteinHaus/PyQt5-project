...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.NumLine.setFont(font)
        self.NumLine.setObjectName("NumLine")
        self.verticalLayout.addWidget(self.NumLine)
        ...
        self.gridLayout.addWidget(self.pushButton_pc, 6, 0, 1, 1)
...
"          }")
        ...
        self.gridLayout.addWidget(self.pushButton_n0, 6, 1, 1, 1)
        self.pushButton_point = QtWidgets.QPushButton(self.centralWidget)
        self.pushButton_point.setMinimumSize(QtCore.QSize(0, 50))
        font = QtGui.QFont()
        font.setPointSize(27)
        font.setBold(False)
        font.setWeight(50)
...
"          }")
        ...
        self.gridLayout.addWidget(self.pushButton_point, 1, 2, 1, 1)
...
"          }")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_point.setShortcut(_translate("MainWindow", "R"))
